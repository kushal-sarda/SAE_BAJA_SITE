    ...
    return (
        <>
            <div className="container" style={{marginTop:"100px"}}>
                <div className="row">
                    <h1 className="text-center" style={{ color: "red", marginBottom:"20px" }}>BAJA SAEINDIA</h1>
