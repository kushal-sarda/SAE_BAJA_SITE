                        ...
                        <div class="col-11">
                            ...
                            <div class="row ">
                                ...
                                <div class="col-xl-2 col-md-4 col-sm-4 col-auto order-1 align-self-end ">
                                    <h6 class="mt-55 mt-2 text-muted bold-text"><b>EMAIL: </b></h6><small> <span><i class="fa fa-envelope" aria-hidden="true"><a className='text-white' style={{textDecoration:"none"}} href="mailto:teamndors@gmail.com">teamndors@gmail.com</a></i></span> </small>
                                </div>
